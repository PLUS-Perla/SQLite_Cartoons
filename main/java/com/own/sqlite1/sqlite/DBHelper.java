...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY" +
                        " AUTOINCREMENT, %s TEXT NOT NULL UNIQUE, %s TEXT NOT NULL," +
                        " %s TEXT NOT NULL, %s TEXT NOT NULL, %s TEXT NOT NULL, %s INTEGER NOT NULL,%s INTEGER NOT NULL )",
                Tables.CARTOON, BaseColumns._ID,
                Contract.Cartoons.ID,
                Contract.Cartoons.NAME,
                Contract.Cartoons.TYPE,
                Contract.Cartoons.LANGUAGE,
                Contract.Cartoons.AUTHOR,
                Contract.Cartoons.CAPITULOS,
                Contract.Cartoons.YEAR));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+Tables.CARTOON);
